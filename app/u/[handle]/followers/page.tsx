...
import { getFollowersByHandle } from "@/app/actions/followers";
...
export default async function FollowersPage({ params }: FollowersPageProps) {
    ...
    // Get initial followers data
    const result = await getFollowersByHandle(handle, undefined, 30);
                ...
                <main className="py-12">
                    ...
                    <header className="mb-8">
                        ...
                        <p className="text-[#556677] text-sm mt-2">
                            {result.totalCount} {result.totalCount === 1 ? 'person follows' : 'people follow'} @{handle}
                        </p>
                    </header>
                    ...
                    {result.isPrivate ? (
                        <div className="flex flex-col items-center justify-center py-16 bg-[#1b2228] rounded-lg border border-white/5">
                            ...
                            <p className="text-[#556677] text-sm mt-2">
                                @{handle} has chosen to keep their followers list private.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-16 bg-[#1b2228] rounded-lg border border-white/5">
                            ...
                            <p className="text-[#556677] text-sm mt-2">
                                Be the first to follow @{handle}!
                            </p>
                        </div>
                    ) : (
                        /* Followers list with load more */
                        <FollowersList
                            handle={handle}
