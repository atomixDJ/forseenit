...
import { getFollowingByHandle, FollowingUser } from "@/app/actions/following";
import { Loader2 } from "lucide-react";

interface FollowingListProps {
    handle: string;
    initialUsers: FollowingUser[];
...
export default function FollowingList({
    ...
    const [users, setUsers] = useState<FollowingUser[]>(initialUsers);
    ...
    const loadMore = () => {
        ...
        startTransition(async () => {
            const result = await getFollowingByHandle(handle, nextCursor, 30);
